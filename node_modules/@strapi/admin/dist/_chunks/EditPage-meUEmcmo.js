...
const useWebhooks = require("./useWebhooks-g9J_FFMC.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-Ftc5pejf.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-meUEmcmo.js.map
