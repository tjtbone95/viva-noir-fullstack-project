...
const ListView$1 = lazy(() => import("./ListView-gBpawLdS.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-gBpawLdS.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-0u4ewOxA.mjs.map
